    ...
    if (message.content.startsWith(`${prefix}mute`)) {
        if (!message.member.permissions.has('MANAGE_MESSAGES')) {
            ...
            if (!userToMute) {
                ...
                var MuteEmbed = new Discord.RichEmbed()
                .setAuthor(message.author.username, message.author.avatarURL)
                .addField(`Le mute a bien été effectué.`,`L'utilisateur ${message.mentions.users.first()} à étais mute par ${message.author.tag}.`)
                .setColor("0x000ff")
                .setFooter("AustelEngine, un produit de Nietsloh Inc. © Tous droits réservés. 2016-2018")
                message.delete()
    ...
    if (message.content.startsWith(`${prefix}unmute`)) {
        if (!message.member.permissions.has('MANAGE_MESSAGES')) {
            ...
            if (!userToMute) {
                ...
                var MuteEmbed = new Discord.RichEmbed()
                .setAuthor(message.author.username, message.author.avatarURL)
                .addField(`Le unmute a bien été effectué.`,`L'utilisateur ${message.mentions.users.first()} à étais demute par ${message.author.tag}.`)
                .setColor("0x000ff")
                .setFooter("AustelEngine, un produit de Nietsloh Inc. © Tous droits réservés. 2016-2018")
                message.delete()
                message.channel.send(MuteEmbed);
